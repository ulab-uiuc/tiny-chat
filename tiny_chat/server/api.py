...
async def get_model_info(
    model_name: str, server: TinyChatServer = Depends(get_server)
) -> ModelInfo:  # noqa: B008
...
async def create_conversation(
    ...
    server: TinyChatServer = Depends(get_server),  # noqa: B008
...
async def get_conversation(conversation_id: str) -> ConversationResponse:  # noqa: B008
...
async def delete_conversation(conversation_id: str) -> dict[str, str]:  # noqa: B008
